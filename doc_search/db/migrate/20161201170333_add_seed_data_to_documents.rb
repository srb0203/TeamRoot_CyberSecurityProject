...
class AddSeedDataToDocuments < ActiveRecord::Migration
  ...
  def up
    ...
    create(document_params)
    document_params = {title: "A Survey Of Insider Attack Detection Research", author: "Malek Ben Salem", doctype: "Research Paper", category:"Cyber Security", keywords:"insider attack", pdflink:"https://static-content.springer.com/lookinside/chp%3A10.1007%2F978-0-387-77322-3_5/000.png"}
    create(document_params)
    document_params = {title: "Cyber Security Of Smart Grid Communications: Risk Analysis And Experimental Testing", author: "Giovanna Dondassola", doctype: "Research Paper", category:"Cyber Security", keywords:"smart grid cyber security", pdflink:"https://static-content.springer.com/lookinside/chp%3A10.1007%2F978-3-662-45928-7_7/000.png"}
    create(document_params)
  end
  def down
    Document.delete_all
